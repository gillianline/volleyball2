...
# --- 1. PAGE CONFIG & PERSISTENT LAYOUT ---
...
if check_password():
    ...
    try:
        ...
        # --- 4. NAVIGATION CONTAINER CONTROL (HARD CONTAINER CLEAR FORCING) ---
        ...
        # ==========================================
        with tabs[5]: 
            t5_position_container = st.container()
            with t5_position_container:
        ...
        # ==========================================
        with tabs[6]: 
            t6_phase_container = st.container()
            with t6_phase_container:
        ...
        # ==========================================
        with tabs[7]: 
            t7_planner_container = st.container()
            with t7_planner_container:
